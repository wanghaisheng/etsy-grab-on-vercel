...
from src.reques.text_format import format_title
from src.reques.text_format import format_description
...
class Product:
    ...
    def get_description(self) -> str:
        ...
        """
        try:
            description_toggle = self.soup.find(
    ...
    def get_review_quantity(self) -> int:
        ...
        """
        try:
            review_quantity = self.soup.find(
                "span", {"class": "wt-badge--statusInformational"}
            )
